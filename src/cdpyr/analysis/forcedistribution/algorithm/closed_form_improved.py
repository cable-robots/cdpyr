...
def evaluate(calculator: '_forcedistribution.Calculator',
    ...
    force_distribution = _closed_form(structurematrix,
                                      force_mean,
                                      wrench)

    # And iterate
    try:
        force_distribution = _reduced_iteration(
            force_distribution,
            structurematrix,
            wrench,
            force_min,
...
def _closed_form(structurematrix: Matrix,
                 force_mean: Vector,
                 wrench: Vector):
...
def _reduced_iteration(current_force_distribution: Vector,
    ...
    reduced_force_distribution = _reduced_iteration(
